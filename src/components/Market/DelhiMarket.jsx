...
const DelhiMarket = () => {
  ...
  const toggleMarketStatus = async (marketId) => {
    try {
      ...
      await axios.put(
        `${API_BASE_URL}/delhi-markets/${marketId}/status`,
        null,
        {
  ...
  const handleEdit = (market) => {
    ...
    setFormData({
      marketType: market.rawData.marketType || "Delhi Market",
    ...
    try {
      ...
      if (editingId) {
        response = await axios.put(
          `${API_BASE_URL}/delhi-markets/${editingId}`,
          requestData,
          {
            headers: getAuthHeaders(),
          }
      ...
      <div className="panel-container">
        ...
        <div className="panel create-panel">
          <div className="panel-header">
            {editingId ? "Edit Delhi Market" : "Create Delhi Market"}
          </div>
        ...
        <div className="panel list-panel">
          <div className="panel-header">Delhi Market List</div>
