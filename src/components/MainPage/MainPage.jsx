...
const MainPage = () => {
    ...
    try {
      ...
      const transformedGames = gamesData.map((game) => {
        ...
        return {
          ...
          name: game.title,
          result: "***-**-***",
          chartLink: "https://kalyan143.xyz/application/panel/test/chart",
  ...
  const openChart = (e) => {
    e.preventDefault();
    window.location.href = "https://kalyan143.xyz/application/panel/test/chart";
  };
                  ...
                  <div className="d-flex justify-content-between w-100">
                    <div className="width_20">
                      <div className="card_icon">
                        <a href="#" className="" onClick={openChart}>
