...
const DeductPoint = () => {
  ...
  useEffect(() => {
    ...
    const fetchTransactions = async () => {
      ...
      try {
        const response = await axios.get(`${API_BASE_URL}/points/debit`, {
          headers: getAuthHeaders(),
        });
  ...
  const handleSave = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${API_BASE_URL}/points/deduct`,
        pointData,
        {
          headers: getAuthHeaders(),
        }
      );
      console.log("Point deducted successfully:", response.data);
      alert("Point deducted successfully!");
      ...
      const res = await axios.get(`${API_BASE_URL}/points/debit`, {
        headers: getAuthHeaders(),
      });
      ...
      handleApiError(err);
      console.error("Error deducting point:", err);
      alert(`Error deducting point: ${err.message}`);
    }
  };

  // Get the selected user's balance
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            <label htmlFor="amount">
              Amount (Balance: {getSelectedUserBalance()}){" "}
